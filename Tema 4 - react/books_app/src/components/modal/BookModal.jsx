...
const ModalOverlay = ({ book, userBooks, addBook, fromSearch }) => {
    ...
    return (
        <div className="modal-active extra-info-card extra-info-card-move">
            ...
            <ModalControl book={book} accessInfo={accessInfo} userBooks={userBooks} addBook={addBook} fromSearch={fromSearch} />
        </div>
    )
}
...
const BookModal = ({ book, onClick, userBooks, addBook, fromSearch }) => {
    return (
        <>
            <BackDrop onClick={onClick} />
            {ReactDOM.createPortal(<ModalOverlay book={book} userBooks={userBooks} addBook={addBook} fromSearch={fromSearch} />, document.getElementById('modal'))}
